...
import {
  ...
  initCases,
  messageCases,
} from "./DeprecationWarning.cases.ts";

import { TrackFailedCase } from "./_util.ts";

const { TestSuite, TestCase, Test } = Testing.decorators;

const ClassCtor = DeprecationWarning;

@TestSuite("DeprecationWarning")
class TestSuiteClass<I extends DeprecationWarningInit = DeprecationWarningInit> {
  @Test("()")
