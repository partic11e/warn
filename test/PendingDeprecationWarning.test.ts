 ...
 */
 ...
 import { PendingDeprecationWarning, PendingDeprecationWarningInit } from "../mod.ts";
 ...
 import {
   ...
   initCases,
   messageCases,
 } from "./PendingDeprecationWarning.cases.ts";
 
 import { TrackFailedCase } from "./_util.ts";
 
 const { TestSuite, TestCase, Test } = Testing.decorators;
 
 const ClassCtor = PendingDeprecationWarning;
 
 @TestSuite("PendingDeprecationWarning")
 class TestSuiteClass<I extends PendingDeprecationWarningInit = PendingDeprecationWarningInit> {
   @Test("()")
